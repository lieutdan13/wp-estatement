...
<form method='post' class='est-form' action='<?php echo admin_url( 'admin-ajax.php' ) ?>' id='add-customdata'>
	...
	<div class='form-row submit-row'>
		...
		<input type='hidden' name='action' value='edit_profilefield'>
		<input type='submit' class='button primary submit' value='+ Edit Profile Field'>
	</div>
...
<?php else : ?>
	...
	<form method='post' class='est-form' action='<?php echo admin_url( 'admin-ajax.php' ) ?>' id='add-customdata'>
		...
		<div class='form-row submit-row'>
			<input type='hidden' name='action' value='add_profilefield'>
			<input type='submit' class='button primary submit' value='+ Add Profile Field'>
		</div>
